...
export function StreamSwitcher({
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {isOpen && (
        <>
          {/* Backdrop: full screen on mobile for bottom sheet, transparent on md+ so dropdown is the focus */}
          <div
            className="fixed inset-0 z-20 bg-black/40 md:bg-transparent"
            aria-hidden
          ...
          <div
            ...
            className="fixed inset-x-0 bottom-0 z-30 max-h-[50vh] overflow-auto rounded-t-2xl border border-b-0 border-[#333] bg-[#1a1a1a] shadow-2xl md:absolute md:bottom-full md:right-0 md:left-auto md:top-auto md:mb-1 md:max-h-[70vh] md:min-w-[200px] md:rounded-lg md:border md:shadow-xl"
          >
